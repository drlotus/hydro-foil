...
void polarization_midrapidity_linear(double pT, double phi, pdg_particle particle, std::vector<element> &freeze_out_sup, ofstream &fileout);
...
void polarization_rapidity(double pT, double phi, double y_rap, pdg_particle particle, vector<element> &freeze_out_sup, std::ofstream &fileout);
